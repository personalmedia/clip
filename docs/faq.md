...
Easily install CLIP PWA on your desktop by clicking the install-button in the top-right corner while on [clip.pm](https://clip.pm).
...
See [this host your own section](https://github.com/personalmedia/clip/blob/master/docs/host-your-own.md#testing-pwa-related-features) for more info.
...
These third-party apps are compatible with CLIP:
...
the CLIP TURN Server is used to route your files and messages.
...
you can [start the CLIP instance with an activated WebSocket fallback](https://github.com/personalmedia/clip/blob/master/docs/host-your-own.md#websocket-fallback-for-vpn).
...
CLIP doesn't even use a database.
If curious, study [the signaling server](https://github.com/personalmedia/clip/blob/master/server/ws-server.js).
...
Still you have to trust the CLIP server. To ensure the connection is secure and there is no [MITM](https://en.m.wikipedia.org/wiki/Man-in-the-middle_attack) there is a plan to make CLIP
zero trust by encrypting the signaling and implementing a verification process. See [issue #180](https://github.com/personalmedia/clip/issues/180) to keep updated.
...
Snapdrop and CLIP are a study in radical simplicity.
...
<details>
<summary style="font-size:1.25em;margin-top: 24px; margin-bottom: 16px; font-weight: var(--base-text-weight-semibold, 600); line-height: 1.25;">
    CLIP is awesome. How can I support it? 
</summary>

<br>

* [Buy me a coffee](https://www.buymeacoffee.com/clip) to pay for the domain and the server, and support libre software.
...
* Participate in [active discussions](https://github.com/personalmedia/clip/discussions)
